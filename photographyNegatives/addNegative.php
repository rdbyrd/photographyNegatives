...
//insert statement. The id field is an auto-incrementing field.
$sql = "INSERT INTO tickets VALUES (NULL, '$firstName', '$lastName', '$dateTaken', '$negativeNum', '$fee', '$jobType', '$description')";
