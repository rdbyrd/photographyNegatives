...
<body>
    ...
    <div class="jumbotron main-header">
        ...
        <p>Add a negative</p>
        <form class='container-fluid' id='fieldInput'>
            <div class='row'>
                <div class ='col-md-6'>
                    ...
                    <input type="number" name ="negativenumber" required><br/>
                    ...
                    <div class='button'>
                        ...
                        <button type="submit" class="btn btn-danger" value="cancel" onClick="window.location.reload()">Cancel</button>
                    </div>
                </div>
            </div>
        </form>
